...
var (
	...
	ErrQuestionCreate                       = errors.New("failed to insert question")
	...
	ErrUserAlreadyRegisteredViaFacequestion = errors.New("user already registered via facequestion")
	...
	ErrLoginAttemptWithFacequestionProvider = errors.New("invalid login attempt")
